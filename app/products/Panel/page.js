  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        // Filter for Panel category
        const panels = allProducts.filter(product => product.category === 'Panel');
        setProducts(panels);
        setError(null);
      } catch (err) {
    ...
    <div className="py-8 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-gray-800 rounded-xl border border-gray-700">
            <p className="text-gray-400 text-lg">No panels found in our inventory.</p>
          </div>
        ) : (
